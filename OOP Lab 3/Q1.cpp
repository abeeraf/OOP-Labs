...
//2
void func1WithRecursion(int n,int s=1)
{
	if(s<0)
	return;
...
funcl(9);
cout<<endl;
func1WithRecursion(9);
cout<<endl;
count(1234563738);
cout<<endl;
cout<<countWithRecursion(1234563);
cout<<endl;
cout<<pow(2,4);
cout<<endl;
cout<<powWithRecursion(2,4);
cout<<endl;
decimalToOctal(92);
cout<<endl;
cout<<decimalToOctalWithRecursion(92);
cout<<endl;
cout<<isPalindrome("MADAM", 0, 5);
cout<<endl;
//cout<<Reverse("HELLO",5);
cout<<endl;
cout<<fab(6);
cout<<endl;
